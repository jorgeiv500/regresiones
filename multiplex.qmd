...
format: 
  revealjs:
    ...
    multiplex:
      secret: 'abc123'              # 🔐 clave secreta para la sesión
      id: 'utadeo-presentacion'     # 📡 ID único de la sesión
      url: 'https://adorable-meowing-danger.glitch.me/'  # 🌍 URL del WebSocket

    plugins:
      - reveal-multiplex            # 🔌 asegura que se cargue el plugin
